...
const tableData = ref<ServerNode[]>([
  { name: "Mac主机", host: "127.0.0.1", port: "22", account: "1111", password: "222", status: true, remark: "Mac构建", addTime: "2020/09/08 10:45" },
  { name: "Win主机", host: "127.0.0.2", port: "22", account: "1111", password: "222", status: true, remark: "Win构建", addTime: "2020/09/08 10:45" },
  { name: "Ubuntu主机", host: "无", port: "", account: "1111", password: "222", status: true, remark: "Ubuntu构建", addTime: "2020/09/08 10:45" },
  { name: "Centos主机", host: "无", port: "", account: "1111", password: "222", status: true, remark: "Centos构建", addTime: "2020/09/08 10:45" },
  { name: "其他主机", host: "无", port: "", account: "1111", password: "222", status: true, remark: "其他", addTime: "2020/09/08 10:45" }
]);
  ...
  ElMessageBox.prompt("请输入节点名称", "新增节点", {
    ...
    .then(({ value }) => {
      tableData.value.unshift({
        name: value, host: "", port: "", account: "", password: "", status: true, remark: "", addTime: new Date().toLocaleString()
      });
    ...
    <div class="search-container">
      <el-form :inline="true" :model="searchForm">
        <el-form-item label="名称">
          <el-input v-model="searchForm.name" placeholder="请输入节点名称" clearable class="w-[200px]" />
        </el-form-item>
        <el-form-item>
          <el-button type="primary" :icon="Search" @click="handleSearch">查询</el-button>
          <el-button type="success" :icon="Plus" @click="handleAdd" class="ml-2">新增</el-button>
        </el-form-item>
      </el-form>
    </div>
